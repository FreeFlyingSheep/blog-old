...
2.6 版本的 Linux 内核源码可以在 <https://www.kernel.org/pub/linux/kernel/v2.6/> 上下载，本系列学习笔记将基于 2.6.34 版本。

本人计划用一年时间，初步阅读这三本书籍，逐渐完善相关学习笔记。

## 书籍简介

这三本讲解 Linux 内核的经典书籍，都基于 Linux 2.6 版本的内核。虽然书中很多内容已经过时，但对于入门内核来说还是非常不错的选择。

### ULK3

基于 Linux 2.6.11 版本，主要介绍的是 Linux 内核的重要数据结构、算法和编程技巧。

本人认为该书侧重于探讨相关概念以及算法的思路，讲解的代码相对较少，需要结合许多其他的资料，才能更好理解，其中部分中文翻译比较拗口。

### LKD3

基于 Linux 2.6.34 版本，主要介绍的是 Linux 内核的设计和实现信息。

本人认为该书侧重于描绘一个内核的总体框架，内容较少，但更容易理解，在没有看过其他内核书籍的前提下，这本书阅读起来是最舒服的。

### PLKA

基于 Linux 2.6.24 版本，主要介绍的是 Linux 内核的概念、结构和实现。

本人认为该书侧重于提供一个 Linux 内核开发指南和手册，各种知识点都有涉及，内容非常多，结合的代码也很多，因此该书很厚，但不少内容没相应的基础并不容易理解，详细未必好懂。
